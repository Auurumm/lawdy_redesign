              ...
              <div className="card border-0 shadow-sm rounded-4">
                <div className="card-body p-4 p-md-5">
                  <form onSubmit={handleSubmit}>
                    ...
                    {/* Name */}
                    <div className="mb-3">
                      <label className="form-label fw-semibold fs-7">이름</label>
                      <input
                        type="text"
                    ...
                    <div className="mb-3">
                      ...
                      <input
                        ...
                        required
                      />
                      <div className={`form-text ${showPasswordError ? 'text-danger' : ''}`}>
                    ...
                    {/* Confirm Password */}
                    <div className="mb-4">
                      <label className="form-label fw-semibold fs-7">비밀번호 확인</label>
                      <input
                        type="password"
                    ...
                    <div className="border rounded-3 p-3 mb-4">
                      <div className="form-check mb-2">
                        ...
                        />
                        <label className="form-check-label fs-7" htmlFor="agreeTerms">
                          <Link href="/terms" className="fw-semibold text-decoration-none" style={{ color: 'var(--tc-theme-primary)' }}>
                            이용약관
                          </Link>
                          에 동의합니다.
                        </label>
                      ...
                      <div className="form-check">
                        ...
                        />
                        <label className="form-check-label fs-7" htmlFor="agreePrivacy">
                          <Link href="/privacy" className="fw-semibold text-decoration-none" style={{ color: 'var(--tc-theme-primary)' }}>
                            개인정보처리방침
                          </Link>
                          에 동의합니다.
                        </label>
                  ...
                  <div className="text-center mt-4">
                    <p className="text-muted fs-7 mb-2">이미 계정이 있으신가요?</p>
                    <Link
                      href="/login"
