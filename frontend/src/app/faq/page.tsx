...
const faqData = {
  general: {
    ...
    items: [
      ...
      },
      {
        ...
        answer: '개인, 변호사, 법률 팀, 기업 등 모든 사용자가 이용할 수 있습니다. 간단한 회원 가입 후 바로 시작할 수 있습니다.',
      },
      {
  ...
  subscription: {
    ...
    items: [
      {
        question: '무료 플랜이 있나요?',
        answer: '현재는 무료로 서비스를 제공하고 있습니다. 회원가입 후 바로 사용하실 수 있습니다.',
      },
      {
      ...
      <section className="py-120">
        <div className="container">
          ...
          <div className="text-center mt-5 pt-5 border-top">
            ...
            <p className="text-secondary mb-4">찾는 질문이 없다면 고객센터로 문의해주세요</p>
