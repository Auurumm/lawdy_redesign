import Breadcrumb from "@/components/template/elements/Breadcrumb"
...
export default function PageHeader({ title, current_page }: PageHeaderProps) {
    return (
        <section className="ai-solutions-section-header position-relative bg-dark-1">
            <img className="position-absolute bottom-0 end-0" data-aos="fade-left" data-aos-delay={400} src="/assets/imgs/pages/ai-solutions/page-home/banner-header.png" alt="Lawdy" />
